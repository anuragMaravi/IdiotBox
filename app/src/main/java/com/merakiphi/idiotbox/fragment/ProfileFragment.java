        ...
        if (request_token == null) {
            ...
            buttonLogin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET, REQUEST_TOKEN + "?redirect_to=https://play.google.com/store/apps/details?id=com.merakiphi.idiotbox",
